...
public class Read {
	...
	public static void reader() {
		...
		System.out.println(
				"Please note that, due to safety reasons, " + "we only allow one item to be viewed at a time.");
		...
		case 5:
			...
			System.out.println(
					ssnString.substring(0, 3) + "-" + ssnString.substring(3, 5) + "-" + ssnString.substring(5, 9));
			break;
		case 6:
		...
		case 8:
			...
			System.out.println(Long.toString(phoneNumber).substring(0, 3) + "-"
					+ Long.toString(phoneNumber).substring(3, 6) + "-" + Long.toString(phoneNumber).substring(6, 9));
			break;
		case 9:
