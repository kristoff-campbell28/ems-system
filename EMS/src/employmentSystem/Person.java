...
public class Person {
	...
	public String toString() {
		return "Person [fullName=" + fullName + ", gender=" + gender + ", age=" + age + ", phoneNumber=" + phoneNumber
				+ ", date=" + dateOfBirth + "]";
	}
	 ...
	 * GenderOptions go;
	 * 
	 * public Person (GenderOptions go) { this.go = go; }
	 * 
	 * 
	 * 
	 * public void genderChoice() { switch(go) {
	 * 
	 * case MALE: System.out.println("store m somehow. "); break;
	 * 
	 * case FEMALE: System.out.println("store f somehow. "); break;
	 * 
	 * case OTHER: System.out.println("store o somehow. "); break; } }
	 */
