...
public class Manager extends Employee {
	...
	public Manager(GENDER gender, int age, long phoneNumber, String dateOfBirth, String fullName, Address address,
		...
		super(gender, age, phoneNumber, dateOfBirth, fullName, address, dateStartWork, dept, employeeID, email, jobTitle, ssn,
				salary, person, address2);
		// TODO Auto-generated constructor stub
	}
	...
	//What's below here is currently unnecessary. Too many steps ahead of where we are now. 
...
/*
	...
	public void setTeam(Set<Integer> team) {
		this.team = team;
	}*/ 
